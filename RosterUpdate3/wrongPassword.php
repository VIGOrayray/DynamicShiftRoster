<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="LoginSpace">
			...
			<h4 style="text-align: center; font-size: 30px; color: #f00;">Wrong Username or Password</h1>
                        <div class="Logospace">
                        </div>
			...
			<div class="form-group input-group">
				...
				<input type="password" name="password" class="form-control" placeholder="Enter Password..." style="width: 400px;" required>
                        ...
                        <div class="form-group" style="width: 130px; margin: 0 auto; margin-bottom: 20px;">
